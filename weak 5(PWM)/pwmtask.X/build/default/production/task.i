...
void init(void);
void pwmchange(void);
    unsigned char lsb20,msb20;
    unsigned char lsb60,msb60;
    unsigned char lsb90,msb90;
    void main() {
        init();
        while(1)
            pwmchange();
    ...
    {
    CCPR1L=msb20;
    CCP1CON=((CCP1CON&0xCF)|lsb20);
    _delay((unsigned long)((3000)*(6000000/4000.0)));
    CCPR1L=msb60;
    CCP1CON=((CCP1CON&0xCF)|lsb60);
    _delay((unsigned long)((3000)*(6000000/4000.0)));
    CCPR1L=msb90;
    CCP1CON=((CCP1CON&0xCF)|lsb90);
    _delay((unsigned long)((3000)*(6000000/4000.0)));
    }
