...
# 10 "function.c" 2
# 20 "function.c"
unsigned char d[15]={"MATRIX KEYPAD"};
...
char keyscan()
{
 RB3=0,RB4=1,RB5=1,RB6=1;
 delay(10);
    if(RB0==0){delay(100);while(RB0==0);return '1';}
    if(RB1==0){delay(100);while(RB1==0);return '2';}
    if(RB2==0){delay(100);while(RB2==0);return '3';}


    RB3=1,RB4=0,RB5=1,RB6=1;
    delay(10);
    if(RB0==0){delay(100);while(RB0==0);return '4';}
    if(RB1==0){delay(100);while(RB1==0);return '5';}
    if(RB2==0){delay(100);while(RB2==0);return '6';}

    RB3=1,RB4=1,RB5=0,RB6=1;
    delay(10);
    if(RB0==0){delay(100);while(RB0==0);return '7';}
    if(RB1==0){delay(100);while(RB1==0);return '8';}
    if(RB2==0){delay(100);while(RB2==0);return '9';}

    RB3=1,RB4=1,RB5=1,RB6=0;
    delay(10);
    if(RB0==0){delay(100);while(RB0==0);return'*';}
    if(RB1==0){delay(100);while(RB1==0);return '0';}
    if(RB2==0){delay(100);while(RB2==0);return '#';}
   return ((void*)0);
