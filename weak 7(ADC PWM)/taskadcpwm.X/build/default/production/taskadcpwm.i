...
void lcdoutput1(unsigned long);
unsigned char n,j;
unsigned char k[10],l[4],o[4];
unsigned char a[10]={"CHANNEL 0:"},b[10]={"CHANNEL 1:"};
...
void main()
{
    ...
    while(1)
    {
        ...
        lowvalue=ADRESL;
        highvalue=ADRESH;
        value=((unsigned long)highvalue<<8)+(unsigned long)lowvalue;
        lcdcmd(0x80);
        for(fr=0;fr!=10;fr++)
        {
            lcddata(a[fr]);
