...
char msg1[5]={"TIME:"};
char msg2[5]={"DATE:"};
char am[2]={"AM"},pm[2]={"PM"};
int i,j,k,l,var;
int sec=55,min=59,hour=11,date=8,month=04,year=24,day=2;
...
void update(void)
{
    ...
    var=i2cread(1);
    hour=(bcd2dec(0x1F&var));
    day=(bcd2dec(i2cread(1)));
    date=(bcd2dec(i2cread(1)));
    month=(bcd2dec(i2cread(1)));
    year=(bcd2dec(i2cread(1)));
    i2cstop();
    i2cstart();
    i2cwrite(0xD1);
    i2cread(1);
